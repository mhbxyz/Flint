...
Generated by Flint using the FastAPI profile (no DB).
...
name = "{project_slug}"
version = "0.1.0"
description = "FastAPI service generated by Flint"
readme = "README.md"
...
def _flint_toml(context: FastAPITemplateContext) -> str:
    return f"""[project]
...
def root() -> dict[str, str]:
    return {"status": "ok", "message": "Flint scaffold is running"}
"""
