...
Flint includes repeatable performance scenarios and regression guardrails.

## Scenarios

- `startup_run`: end-to-end startup latency for `flint run` in a generated sample project.
